...
def search_cbd_shops():
    url = 'https://maps.googleapis.com/maps/api/place/textsearch/json'
    params = {
        'query': 'cbd shop france',
...
def main():
    cbd_shops = search_cbd_shops()

    with open('cbd_shops.csv', mode='w', newline='', encoding='utf-8') as file:
        fieldnames = ['Name', 'Address', 'Phone Number', 'Has Website', 'Opening Hours']
        writer = csv.DictWriter(file, fieldnames=fieldnames)

        writer.writeheader()

        for shop in cbd_shops:
